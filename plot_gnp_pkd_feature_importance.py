"""
Plot feature importance for GNP pKD model with normalized importance values.
Highlights embedding features in red, others in blue.
"""
...
work_dir = '/Users/chrishe/Documents/Untitled Folder 3/xgboost_training/gnp_pkd_results/'
...
# Get top 300 features (or all if less than 300)
top_n = min(300, len(feature_df))
...
plt.title(f'Top {top_n} Feature Importances - GNP pKD Model\n(Embeddings: {num_pepland}, Other: {num_other})', 
...
# Save the plot
output_path = os.path.expanduser('~/Downloads/gnp_pkd_feature_importance_normalized.png')
